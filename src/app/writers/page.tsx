          ...
          <div className="grid grid-cols-1 lg:grid-cols-[minmax(0,1fr)_minmax(0,520px)] gap-x-10 lg:gap-x-20 gap-y-6 items-start">
            ...
            <div>
              ...
              <p className="mt-3 text-sm text-muted-foreground leading-relaxed max-w-md">
                Reporters measure what moved after publication: coverage,
                reach, message pickup, SERP movement, and AI citation change.
                Every program writes back to the narrative graph.
              </p>
              <Link
                href="/reporters"
