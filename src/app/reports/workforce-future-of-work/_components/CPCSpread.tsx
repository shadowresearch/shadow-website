...
// Bar chart of weighted CPC by narrative — what enterprise buyers will actually pay.
// White Collar Compression is the highlight: highest CPC on lowest media share.
  ...
  return (
    <figure className="w-full">
      ...
      <svg
        ...
        role="img"
        aria-label="Bar chart of weighted CPC per narrative; White Collar Compression is highest at $29.08."
      >
        {rows.map((r, i) => {
          const y = padT + i * rowH;
        ...
        <g>
          ...
          <text
            ...
            fill={palette.dusk}
          >
            6.5× the displacement narrative on a fraction of the volume
          </text>
        </g>
      </svg>
