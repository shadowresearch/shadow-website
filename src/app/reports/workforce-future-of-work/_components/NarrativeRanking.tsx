...
// Horizontal ordered bar of monthly media volume across the 5 workforce narratives.
// Top bar (Displacement) in Dusk; rest in Shade.
  ...
  return (
    <figure className="w-full">
      ...
      <svg
        ...
        role="img"
        aria-label="Ranked horizontal bar chart of workforce narratives by April 2026 article volume."
      >
        {rows.map((r, i) => {
          const y = padT + i * rowH;
        ...
        <g>
          ...
          <text
            ...
            fill={palette.dusk}
          >
            45% of all workforce coverage in a single narrative
          </text>
        </g>
      </svg>
