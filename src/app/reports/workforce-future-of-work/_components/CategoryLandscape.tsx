...
// Daily total media volume across all 5 workforce narratives, 28 days.
// History line in shade; weekend dips visible. Annotation marks the 28-day total.
...
export function CategoryLandscape() {
  ...
  // Highlight the single highest day (2026-04-23, 1,180 articles).
  ...
  return (
    <figure className="w-full">
      ...
      <svg
        ...
        role="img"
        aria-label="Daily total article volume across five workforce narratives, with peak day annotated."
      >
        {yTicks.map((t) => (
          <g key={t}>
            <text
        ...
        <text
          ...
          fill={palette.dusk}
        >
          Peak day: {formatComma(peak.total)} articles
        </text>
      ...
      <p className="mt-4 text-[11px] font-mono text-muted-foreground tracking-wide">
        Source: Perigon; Shadow analysis. Sum across 5 narratives. n = {formatComma(grandTotal)} articles.
      </p>
    </figure>
  );
}
