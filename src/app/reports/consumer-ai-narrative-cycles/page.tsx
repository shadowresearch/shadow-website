    ...
    <div className="flex flex-col bg-card">
              ...
              <div className="relative p-6 lg:p-8">
                <div>
                  ...
                  <div className="mt-3 space-y-1 text-[14px] text-background leading-snug">
                    <p>One cycle changed leadership.</p>
                    <p>
                      Four more shape what positioning in consumer AI looks
                      like next.
                    </p>
                  </div>
                  ...
                  <ol className="mt-7 space-y-5">
                    <li className="grid grid-cols-[auto_minmax(0,1fr)] gap-x-5">
                      ...
                      <div>
                        <h3 className="font-serif font-medium text-[clamp(1rem,1.3vw,1.15rem)] text-background leading-snug">
                          Agentic AI passed generative AI for the first time.
                        </h3>
                        <div className="mt-1.5 space-y-0.5 text-[13.5px] md:text-[14px] text-background/95 leading-snug">
                          <p>
                            180,822 quarterly articles in Q1 2026 &mdash; the
                            largest narrative volume in the dataset.
                          </p>
                          <p>The category has a new top story.</p>
                        </div>
                      </div>
                    </li>
                    ...
                    <li className="grid grid-cols-[auto_minmax(0,1fr)] gap-x-5">
                      ...
                      <div>
                        <h3 className="font-serif font-medium text-[clamp(1rem,1.3vw,1.15rem)] text-background leading-snug">
                          Generative AI didn&apos;t fade. It got repurposed.
                        </h3>
                        <div className="mt-1.5 space-y-0.5 text-[13.5px] md:text-[14px] text-background/95 leading-snug">
                          <p>
                            Q1 2026 volume exceeded the original 2023 peak by
                            11%.
                          </p>
                          <p>Same words, different editorial weight.</p>
                        </div>
                      </div>
                    </li>
                    ...
                    <li className="grid grid-cols-[auto_minmax(0,1fr)] gap-x-5">
                      ...
                      <div>
                        ...
                        <div className="mt-1.5 space-y-0.5 text-[13.5px] md:text-[14px] text-background/95 leading-snug">
                          <p>+188% QoQ, the leader in the dataset.</p>
                          <p>
                            Structurally positioned as the next dominant cycle.
                          </p>
                        </div>
                      </div>
                    </li>
                    ...
                    <li className="grid grid-cols-[auto_minmax(0,1fr)] gap-x-5">
                      ...
                      <div>
                        <h3 className="font-serif font-medium text-[clamp(1rem,1.3vw,1.15rem)] text-background leading-snug">
                          Cycles are compressing by roughly 33% per generation.
                        </h3>
                        <div className="mt-1.5 space-y-0.5 text-[13.5px] md:text-[14px] text-background/95 leading-snug">
                          <p>The next peak arrives in 2 to 3 quarters, not 6.</p>
                          <p>
                            The positioning window is half what it was last
                            cycle.
                          </p>
                        </div>
                      </div>
                    ...
                    <li className="grid grid-cols-[auto_minmax(0,1fr)] gap-x-5">
                      ...
                      <div>
                        <h3 className="font-serif font-medium text-[clamp(1rem,1.3vw,1.15rem)] text-background leading-snug">
                          Buyer intent lags media by only 1 to 2 quarters.
                        </h3>
                        <div className="mt-1.5 space-y-0.5 text-[13.5px] md:text-[14px] text-background/95 leading-snug">
                          <p>
                            Less than half the lag seen in cloud computing.
                          </p>
                          <p>Press signal converts to demand quickly here.</p>
                        </div>
                      </div>
                    </li>
                  </ol>
      ...
      <section className="px-8 md:px-16 pb-16">
        <div className="max-w-[960px] mx-auto relative rounded-2xl overflow-hidden">
          ...
          />
          {/* Outer padding — glass card fills the rest */}
          <div className="relative p-3 lg:p-5">
            <div
              className="relative rounded-2xl overflow-hidden backdrop-blur-3xl backdrop-saturate-150 bg-foreground/[0.55] isolate"
              style={{
