...
export default function WhatIsShadowContent() {
  return (
    <>
      <p>
      ...
      <ResourceH2>What Is Shadow?</ResourceH2>
      ...
      <ResourceH2>Why Does Shadow Exist?</ResourceH2>
      ...
      <ResourceH3>The Tool Fragmentation Problem</ResourceH3>
      ...
      <ResourceH3>The Holding Company Infrastructure Gap</ResourceH3>
      ...
      <ResourceH3>The Capacity Ceiling</ResourceH3>
      ...
      <ResourceH2>What Does Shadow Cover?</ResourceH2>
      ...
      <ResourceH3>Operations</ResourceH3>
      ...
      <ResourceH3>Services</ResourceH3>
      ...
      <ResourceH3>Intelligence</ResourceH3>
      ...
      <ResourceH3>Monitoring</ResourceH3>
      ...
      <ResourceH3>Reporting</ResourceH3>
      ...
      <ResourceH2>How Is Shadow Different from PR Tools?</ResourceH2>
        ...
        <table className="w-full text-sm border-collapse">
          <thead>
            <tr className="border-b border-border">
              ...
              <th className="text-left py-3 pr-4 font-semibold">Point Tools (Cision, Muck Rack, Meltwater)</th>
              <th className="text-left py-3 pr-4 font-semibold">Shadow (PR Operating System)</th>
            </tr>
          </thead>
          <tbody>
            <tr className="border-b border-border">
              <td className="py-3 pr-4 font-medium">Scope</td>
              <td className="py-3 pr-4">One or two functions (database, monitoring, reporting)</td>
              <td className="py-3 pr-4">All five functional areas in one system</td>
            </tr>
            <tr className="border-b border-border">
              <td className="py-3 pr-4 font-medium">Context</td>
              <td className="py-3 pr-4">Stateless; every session starts from zero</td>
              <td className="py-3 pr-4">Client-persistent; retains full history and positioning</td>
            </tr>
            <tr className="border-b border-border">
              <td className="py-3 pr-4 font-medium">Coordination</td>
              <td className="py-3 pr-4">No data sharing between tools; human integration required</td>
              <td className="py-3 pr-4">Unified data layer; outputs from one workflow inform the next</td>
            </tr>
            <tr className="border-b border-border">
              <td className="py-3 pr-4 font-medium">Execution</td>
              <td className="py-3 pr-4">Surfaces information for humans to act on</td>
              <td className="py-3 pr-4">Executes complete workflows autonomously, with human review</td>
            </tr>
            <tr className="border-b border-border">
              <td className="py-3 pr-4 font-medium">Economics</td>
              <td className="py-3 pr-4">Per-seat, per-tool pricing; integration labor hidden</td>
              <td className="py-3 pr-4">Platform pricing; integration labor eliminated</td>
            </tr>
          </tbody>
        </table>
      </div>
      ...
      <ResourceH2>How Is Shadow Different from Holding Company Platforms?</ResourceH2>
      ...
      <ResourceH2>What Results Does Shadow Produce?</ResourceH2>
      ...
      <p>
        Amity Gay, Senior Vice President of Communications at Outcast, described using Shadow&apos;s proposal agent to build a pitch for a major enterprise client: &quot;It gives me feedback on the what and why, particularly when I request a change. It arranges things in a thoughtful, human-like way vs. an obvious AI format.&quot; The process saved considerable time on content consolidation.
      </p>
      ...
      <ResourceH2>Who Is Shadow For?</ResourceH2>
      ...
      <ul className="list-disc pl-6 space-y-2">
        <li>Shadow is a PR operating system, not a point tool or monitoring platform.</li>
        <li>It covers five functional areas: operations, services, intelligence, monitoring, and reporting.</li>
        <li>AI agents retain persistent context about each client, creating compounding intelligence over time.</li>
        <li>Shadow gives independent agencies the same structural capabilities as holding company AI platforms.</li>
        <li>Outcast reduced new business processing from days to under 10 minutes; Haymaker cut events workload in half within four weeks.</li>
      </ul>

      <ResourceH2>Frequently Asked Questions</ResourceH2>

      <ResourceH3>Is Shadow a replacement for Cision or Meltwater?</ResourceH3>
      ...
      <ResourceH3>How is Shadow different from using ChatGPT for PR?</ResourceH3>
      ...
      <ResourceH3>Does Shadow require a technical team to implement?</ResourceH3>
      ...
      <ResourceH3>What size agency is Shadow designed for?</ResourceH3>
      ...
      <ResourceH3>Can Shadow work alongside existing tools?</ResourceH3>
