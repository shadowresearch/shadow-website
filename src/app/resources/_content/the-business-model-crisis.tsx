...
export default function TheBusinessModelCrisisContent() {
  return (
    <>
      <p>
      ...
      <ResourceH2>Why Are Large Clients Bringing PR In-House?</ResourceH2>
      ...
      <ResourceH2>What Is the Headcount Trap in PR Agencies?</ResourceH2>
      ...
      <ul className="list-disc pl-6 space-y-2">
        <li>Agencies become busier but not healthier.</li>
        <li>Revenue may be preserved short-term, but baseline costs (salaries, overhead, coordination load) rise permanently.</li>
        <li>In downturns, this exposure becomes acute: salaries must still be paid even as client churn increases.</li>
      </ul>
      ...
      <ResourceH2>Why Does Adding Headcount No Longer Create Proportional Value?</ResourceH2>
      ...
      <div className="overflow-x-auto my-6">
        <table className="w-full text-sm border-collapse">
          ...
          <tbody>
            <tr className="border-b">
              <td className="py-2 pr-4">In-house teams that say their agency partnership is going well</td>
              <td className="py-2 pr-4">13%</td>
              <td className="py-2">Superside 2025 survey</td>
            </tr>
            <tr className="border-b">
              <td className="py-2 pr-4">In-house teams that have lost faith in agencies entirely</td>
              <td className="py-2 pr-4">51%</td>
              <td className="py-2">Superside 2025</td>
            </tr>
            <tr className="border-b">
              <td className="py-2 pr-4">Top 250 PR firms combined fee income</td>
              <td className="py-2 pr-4">$18 billion</td>
              <td className="py-2">Industry data</td>
            </tr>
          </tbody>
        </table>
      </div>
      ...
      <ResourceH2>What Is the Efficiency Ceiling in PR Agency Operations?</ResourceH2>
      ...
      <ul className="list-disc pl-6 space-y-2">
        <li>More channels to monitor across fragmented media ecosystems</li>
        <li>More trust contexts to navigate with proximity-based credibility</li>
        <li>More pressure to prove ROI in quantitative terms</li>
        <li>More speed and more sophistication required</li>
      </ul>
      ...
      <ResourceH2>What Comes After the Traditional Agency Model?</ResourceH2>
      ...
      <ul className="list-disc pl-6 space-y-2">
        <li><strong>The PR agency business model is structurally failing</strong> because revenue is tied to headcount while operating demands exceed what headcount can sustain.</li>
        <li><strong>Large clients are internalizing PR</strong> because continuous, real-time communications are difficult to deliver through an external model designed for periodic engagement.</li>
        <li><strong>The headcount trap</strong> forces agencies to replace lost whale-client revenue with volume, but costs rise faster than revenue as coordination burden grows.</li>
        <li><strong>Only 13% of in-house teams say their agency partnership is going well.</strong> 51% have lost faith in agencies entirely (Superside 2025).</li>
        <li><strong>The efficiency ceiling</strong> means process optimization alone cannot solve a model where revenue is fundamentally tied to the number of people on staff.</li>
        <li><strong>The next model concentrates human effort on judgment</strong> and moves coordination, context management, and operational mechanics to AI infrastructure.</li>
      </ul>

      <ResourceH2>Frequently Asked Questions</ResourceH2>

      <ResourceH3>Why are PR agencies losing large clients?</ResourceH3>
      ...
      <ResourceH3>What is the headcount trap in PR agencies?</ResourceH3>
      ...
      <ResourceH3>What is the efficiency ceiling for PR agencies?</ResourceH3>
