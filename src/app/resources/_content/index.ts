...
const contentMap: Record<string, () => Promise<{ default: ComponentType }>> = {
  ...
  "ai-in-pr-agencies-2026": () => import("./ai-in-pr-agencies-2026"),
  "cision-alternatives-ai-pr": () => import("./cision-alternatives-ai-pr"),
  "ai-media-monitoring-tools": () => import("./ai-media-monitoring-tools"),
  "ai-agency-tech-stack-replacement": () => import("./ai-agency-tech-stack-replacement"),
  "geo-for-pr-agencies": () => import("./geo-for-pr-agencies"),
  "shadow-vs-cision-vs-muck-rack": () => import("./shadow-vs-cision-vs-muck-rack"),
  "shadow-vs-solaraimpact": () => import("./shadow-vs-solaraimpact"),
  "best-ai-platform-pr-agencies": () => import("./best-ai-platform-pr-agencies"),
  "ai-tools-communications-agencies": () => import("./ai-tools-communications-agencies"),
  "compare-agency-ai-solutions": () => import("./compare-agency-ai-solutions"),
  "ai-agents-pr-communications": () => import("./ai-agents-pr-communications"),
  "ai-assistant-public-relations": () => import("./ai-assistant-public-relations"),
  "ai-agents-press-releases-pitches": () => import("./ai-agents-press-releases-pitches"),
  "ai-agent-media-monitoring": () => import("./ai-agent-media-monitoring"),
  "ai-agents-replace-pr-tools": () => import("./ai-agents-replace-pr-tools"),
  "automate-pr-client-onboarding": () => import("./automate-pr-client-onboarding"),
  "automate-monthly-pr-reporting": () => import("./automate-monthly-pr-reporting"),
  "maintain-brand-voice-ai-pr": () => import("./maintain-brand-voice-ai-pr"),
