...
export default function TheTrustShiftContent() {
  return (
    <>
      <p>
      ...
      <ResourceH2>What Is Proximity-Based Trust?</ResourceH2>
      ...
      <ResourceH2>Why Did Institutional Trust Decline?</ResourceH2>
      ...
      <ResourceH2>How Has the Trust Shift Changed PR Strategy?</ResourceH2>
      ...
      <ul className="list-disc pl-6 space-y-2">
        <li><strong>Media placement alone is insufficient.</strong> A Wall Street Journal feature might move a stock price but go completely unnoticed by the developer community a company actually needs to reach. A viral TikTok might drive consumer awareness but carry zero weight with enterprise buyers. Influence has become situational.</li>
        <li><strong>Format matters as much as outlet.</strong> Social video news consumption grew from 52% to 65% between 2020 and 2025, according to Reuters Institute. Across all markets, 75% of audiences consume some form of video news weekly, up from 67% five years ago. A podcast host who speaks conversationally for two hours creates a sense of proximity that a 600-word article cannot replicate.</li>
        <li><strong>Domain expertise is distributed.</strong> Younger audiences have developed what Reuters researchers describe as a &quot;flatter pattern of trust&quot;: gathering information across sources without a shared sense of a hierarchy of validation. A well-sourced Substack post or a detailed Reddit analysis competes directly with institutional media for credibility.</li>
      </ul>
      ...
      <ResourceH2>What Does This Mean for Communications Agencies?</ResourceH2>
      ...
      <ul className="list-disc pl-6 space-y-2">
        <li><strong>Trust has reorganized around proximity, not prestige.</strong> Audiences assign credibility based on shared experience and community embeddedness rather than institutional authority (Edelman Trust Barometer 2025).</li>
        <li><strong>Journalists are trusted by only 52% of global respondents,</strong> below &quot;my neighbors,&quot; while scientists and teachers lead at 77% and 75% (Edelman 2025).</li>
        <li><strong>Social media overtook TV and news websites as the #1 news source in the United States</strong> for the first time in 2025 (Reuters Institute 2025).</li>
        <li><strong>Video and audio formats are winning.</strong> 75% of audiences consume video news weekly, up from 67% five years ago (Reuters 2025).</li>
        <li><strong>Domain expertise has become distributed.</strong> Younger audiences assess credibility case by case rather than defaulting to institutional hierarchies (Reuters 2025).</li>
        <li><strong>PR strategy must shift from placement to proximity.</strong> Mapping trust networks within specific communities requires persistent intelligence infrastructure, not just media lists.</li>
      </ul>

      <ResourceH2>Frequently Asked Questions</ResourceH2>

      <ResourceH3>What is proximity-based trust in communications?</ResourceH3>
      ...
      <ResourceH3>Why is trust in traditional media declining?</ResourceH3>
      ...
      <ResourceH3>How does the trust shift affect PR strategy?</ResourceH3>
      ...
      <ResourceH3>What evidence supports the shift from institutional to proximity-based trust?</ResourceH3>
