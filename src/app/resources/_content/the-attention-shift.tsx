...
export default function TheAttentionShiftContent() {
  return (
    <>
      <p>
      ...
      <ResourceH2>What Did PR&apos;s Structural Advantage Actually Look Like?</ResourceH2>
      ...
      <ResourceH2>How Did Audiences Become Active Participants in Narratives?</ResourceH2>
      ...
      <ResourceH2>Why Is There No Longer a Single &quot;Public&quot; to Address?</ResourceH2>
      ...
      <ul className="list-disc pl-6 space-y-2">
        <li>A Wall Street Journal feature might move a stock price but go completely unnoticed by the developer community a company actually needs to reach.</li>
        <li>A viral TikTok might drive consumer awareness but carry zero weight with enterprise buyers.</li>
        <li>Prestige alone does not guarantee reach. Reach alone does not guarantee impact.</li>
      </ul>
      ...
      <ResourceH2>What Does Media Fragmentation Mean for PR Agencies?</ResourceH2>
      ...
      <ul className="list-disc pl-6 space-y-2">
        <li><strong>Concentrated attention</strong> has been replaced by distributed, platform-specific audiences.</li>
        <li><strong>Passive audiences</strong> have become active participants who interpret and reshape messages in real time.</li>
        <li><strong>Shared context</strong> has fragmented into distinct cultural ecosystems with different credibility signals.</li>
        <li><strong>Slow feedback loops</strong> have compressed into hours or minutes.</li>
      </ul>
      ...
      <ul className="list-disc pl-6 space-y-2">
        <li><strong>Media fragmentation dismantled PR&apos;s structural architecture, not just its channels.</strong> The cost of publishing dropped to zero, enabling individuals and communities to speak at scale through decentralized networks.</li>
        <li><strong>71% of agency teams cite media fragmentation as a major operational hurdle</strong> (Cision Inside PR 2026).</li>
        <li><strong>Audiences are now active participants in narratives,</strong> responding to, reinterpreting, and reshaping messages in public, at scale, in real time.</li>
        <li><strong>AI-driven answers are up 81% since 2024,</strong> with press release citations by LLMs growing fivefold since mid-2025 (Muck Rack).</li>
        <li><strong>There is no longer a single &quot;public&quot; to address.</strong> Algorithmic personalization has splintered audiences into distinct cultural contexts with different credibility signals.</li>
        <li><strong>Communication is now a continuous process, not a series of moments.</strong> PR agencies need persistent intelligence infrastructure to operate across a dozen distinct information ecosystems simultaneously.</li>
      </ul>

      <ResourceH2>Frequently Asked Questions</ResourceH2>

      <ResourceH3>What is media fragmentation in public relations?</ResourceH3>
      ...
      <ResourceH3>How has media fragmentation changed PR strategy?</ResourceH3>
      ...
      <ResourceH3>What is the attention shift in PR?</ResourceH3>
      ...
      <ResourceH3>Why are PR agencies struggling with media fragmentation?</ResourceH3>
      ...
      <ResourceH3>How are AI-generated answers affecting public relations?</ResourceH3>
