...
export default function WhatIsAgencyInfrastructureContent() {
  return (
    <>
      <p>
      ...
      <ResourceH2>Why Does Agency Infrastructure Matter Now?</ResourceH2>
      ...
      <ResourceH3>The Headcount-Revenue Trap</ResourceH3>

      <p>
        PR agencies sell expertise delivered through time. Growth requires either more people or more output per person. The traditional path (hire more people) scales costs linearly with revenue, keeping margins flat at 15&ndash;25% for most agencies. According to the 2025 PRCA Census, 68% of agency leaders cite margin pressure as their primary operational challenge.
      </p>

      <p>
        Infrastructure changes the equation. When systems handle research, first drafts, monitoring, reporting, and operational coordination, each practitioner&apos;s capacity expands. Revenue can grow without proportional headcount growth. This is not a theoretical concept: agencies running on integrated infrastructure report capacity increases of 2&ndash;3x per practitioner across measurable workflows like new business processing, proposal generation, and coverage reporting.
      </p>

      <ResourceH3>Tool Fragmentation</ResourceH3>

      <p>
        The average mid-size agency runs five to eight disconnected software subscriptions at a combined cost of $50,000 to $150,000 annually. But the software cost is only 25&ndash;40% of the real expense. The remaining 60&ndash;75% is the invisible integration labor: the hours practitioners spend copying data between tools, reformatting outputs, maintaining parallel records, and manually stitching together workflows that should be connected.
      </p>

      <p>
        This integration tax is the largest hidden cost in agency operations. It does not appear on any budget line. It manifests as senior practitioners spending 40&ndash;60% of their time on operational tasks instead of strategy, relationships, and judgment.
      </p>

      <ResourceH3>The AI Adoption Gap</ResourceH3>
      ...
      <ResourceH2>The Six Layers of Agency Infrastructure</ResourceH2>
      ...
      <ResourceH3>Layer 1: Data</ResourceH3>
      ...
      <ResourceH3>Layer 2: Measurement</ResourceH3>
      ...
      <ResourceH3>Layer 3: Strategy</ResourceH3>
      ...
      <ResourceH3>Layer 4: Production</ResourceH3>
      ...
      <ResourceH3>Layer 5: Governance</ResourceH3>
      ...
      <ResourceH3>Layer 6: Mechanics</ResourceH3>
      ...
      <ResourceH2>Agency Infrastructure vs. a PR Operating System</ResourceH2>
      ...
      <ResourceH2>How Holding Companies Are Building Agency Infrastructure</ResourceH2>
      ...
      <ul className="list-disc pl-6 space-y-2">
        <li><strong>WPP Open:</strong> An AI-powered operating system connecting WPP&apos;s agencies, data, and AI capabilities across a unified platform.</li>
        <li><strong>Publicis CoreAI (Marcel):</strong> A centralized AI backbone that connects Publicis agencies to shared data, tools, and intelligence.</li>
        <li><strong>Omnicom Omni:</strong> An integrated platform providing data, analytics, and AI capabilities across Omnicom&apos;s agency network.</li>
        <li><strong>Stagwell The Machine:</strong> A suite of AI tools and shared services for agencies within the Stagwell network.</li>
        <li><strong>Havas Converged.AI:</strong> An AI-augmented operating system integrating Havas&apos;s media, creative, and health capabilities.</li>
      </ul>
      ...
      <ResourceH2>How Shadow Provides Agency Infrastructure</ResourceH2>
      ...
      <ResourceH2>How to Evaluate Whether Your Agency Has Infrastructure</ResourceH2>
        ...
        <table className="w-full text-sm border-collapse">
          <thead>
            <tr className="border-b border-border">
              <th className="text-left py-3 pr-4 font-semibold">Layer</th>
              <th className="text-left py-3 pr-4 font-semibold">Fragmented (No Infrastructure)</th>
              <th className="text-left py-3 pr-4 font-semibold">Integrated (Infrastructure)</th>
            </tr>
          </thead>
          <tbody>
            <tr className="border-b border-border">
              <td className="py-3 pr-4 font-medium">Data</td>
              <td className="py-3 pr-4">Client information lives in 5+ disconnected systems</td>
              <td className="py-3 pr-4">One unified data layer accessible to all workflows</td>
            </tr>
            <tr className="border-b border-border">
              <td className="py-3 pr-4 font-medium">Measurement</td>
              <td className="py-3 pr-4">Manual data pulls from multiple monitoring tools</td>
              <td className="py-3 pr-4">Background monitoring with automated surfacing</td>
            </tr>
            <tr className="border-b border-border">
              <td className="py-3 pr-4 font-medium">Strategy</td>
              <td className="py-3 pr-4">Lives in senior practitioners&apos; heads; lost when they leave</td>
              <td className="py-3 pr-4">Codified, persistent, accessible to the entire team</td>
            </tr>
            <tr className="border-b border-border">
              <td className="py-3 pr-4 font-medium">Production</td>
              <td className="py-3 pr-4">Every deliverable starts from scratch</td>
              <td className="py-3 pr-4">Accumulated context informs every output</td>
            </tr>
            <tr className="border-b border-border">
              <td className="py-3 pr-4 font-medium">Governance</td>
              <td className="py-3 pr-4">Ad hoc review when someone has time</td>
              <td className="py-3 pr-4">Rules embedded in the system; consistent enforcement</td>
            </tr>
            <tr className="border-b border-border">
              <td className="py-3 pr-4 font-medium">Mechanics</td>
              <td className="py-3 pr-4">Manual pipeline, proposals, contracts, onboarding</td>
              <td className="py-3 pr-4">Automated operational workflows end to end</td>
            </tr>
          </tbody>
        </table>
      </div>
      ...
      <ul className="list-disc pl-6 space-y-2">
        <li>Agency infrastructure is the integrated system of data, measurement, strategy, production, governance, and mechanics that enables an agency to operate at scale.</li>
        <li>A PR operating system is the product category that provides agency infrastructure as a platform.</li>
        <li>Most agencies run five to eight disconnected tools with an integration tax that costs more than the software itself.</li>
        <li>Holding companies are investing heavily in proprietary AI platforms; independent agencies need an open alternative.</li>
        <li>Shadow is the PR operating system that provides all six infrastructure layers to independent agencies.</li>
      </ul>

      <ResourceH2>Frequently Asked Questions</ResourceH2>

      <ResourceH3>What is the difference between agency infrastructure and a PR operating system?</ResourceH3>
      ...
      <ResourceH3>Does every agency need infrastructure?</ResourceH3>
      ...
      <ResourceH3>How is agency infrastructure different from project management software?</ResourceH3>
      ...
      <ResourceH3>Can an agency build its own infrastructure instead of adopting a platform?</ResourceH3>
      ...
      <ResourceH3>How long does it take to implement agency infrastructure?</ResourceH3>
